...
public class CannonView extends SurfaceView
    ...
    public static final double BLOCKER_LENGTH_PERCENT = 0.5 / 4;
    public static final double BLOCKER_X_PERCENT = 1.0 / 2;
    public static final double BLOCKER_SPEED_PERCENT = 1.0;

    // constants for the Blocker2
    public static final double BLOCKER2_WIDTH_PERCENT = 1.0 / 40;
    public static final double BLOCKER2_LENGTH_PERCENT = 0.5 / 4;
    public static final double BLOCKER2_X_PERCENT = 1.0 / 3;
    public static final double BLOCKER2_SPEED_PERCENT = 0.5;
    ...
    private Blocker2 blocker2;
    private ArrayList<Target> targets;

    // game score
    private int score; // current score
    private int level; // game level
    private int highScore; // tracks the highest score
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        textPaint.setAntiAlias(true); // smooths the text
    }
    ...
    public void newGame() {
        ...
        // reset score if the last game was lost
        if (timeLeft <= 0) {
            resetScore();
        } else {
            level = level + 1;
            if (score > highScore) {
                highScore = score; // save high score
            }
        }
        ...
        // create a new Blocker2
        blocker2 = new Blocker2(this, Color.BLACK, MISS_PENALTY,
                (int) (BLOCKER2_X_PERCENT * screenWidth),
                (int) ((0.5 - BLOCKER2_LENGTH_PERCENT / 2) * screenHeight),
                (int) (BLOCKER2_WIDTH_PERCENT * screenWidth),
                (int) (BLOCKER2_LENGTH_PERCENT * screenHeight),
                (float) (BLOCKER2_SPEED_PERCENT * screenHeight));
                ...
                new DialogFragment() {
                    ...
                    public Dialog onCreateDialog(Bundle bundle) {
                        ...
                        builder.setMessage(getResources().getString(
                                R.string.results_format, shotsFired, totalElapsedTime, score, level));
    ...
    public void drawGameElements(Canvas canvas) {
        ...
        canvas.drawText(getResources().getString(R.string.high_score, highScore), 50, 160, textPaint);
        canvas.drawText(getResources().getString(R.string.current_score, score), 50, 220, textPaint);
